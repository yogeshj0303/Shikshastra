...
.nav-item {
  border-bottom: 1px solid #ddd; /* Adjust border style and color as needed */
}
...
.nav-item::after {
  ...
  display: block;
  width: 100%;
  height: 1px; /* Adjust separator thickness */
  background-color: #ddd; /* Adjust separator color */
  position: absolute;
  bottom: 0;
  left: 0;
}
...
.nav-item:last-child::after {
  display: none; /* Hide separator on the last item */
}
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
        <ul class="navbar-nav font-weight-bold mx-auto py-0">
          ...
          $subjectsByClass = DB::table('subjects')
            ...
            ->take(4) // Take the first 5 records in descending order
            ->get()
            ->reverse();
?>
          <!-- <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Grammer</a>
            <ul class="dropdown-menu rounded-0 m-0">
              <li class="nav-item dropdown-submenu">
                <a href="blog.html" class="dropdown-item">Class 1 English Grammer</a>
                <ul class="dropdown-menu rounded-0 m-0">
                  <li><a href="subpage1.html" class="dropdown-item">Subpage 1</a></li>
                  <li><a href="subpage2.html" class="dropdown-item">Subpage 2</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown-submenu">
                <a href="blog.html" class="dropdown-item">Class 2 English Grammer</a>
                <ul class="dropdown-menu rounded-0 m-0">
                  <li><a href="subpage1.html" class="dropdown-item">Subpage 1</a></li>
                  <li><a href="subpage2.html" class="dropdown-item">Subpage 2</a></li>
                </ul>
          ...
          <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Sample Pepper</a>
            <ul class="dropdown-menu rounded-0 m-0">
  ...
  <li class="nav-item dropdown-submenu">
    <a href="blog.html" class="dropdown-item">{{$class->name}}</a>
