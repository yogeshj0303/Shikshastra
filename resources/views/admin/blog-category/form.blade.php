...
<div class="pcoded-main-container">
    ...
    <div class="pcoded-content">
        ...
        <div class="row">
                            ...
                            @if($user->is_admin==1||$permission->cat_blog_add==2) 
            <div class="col-sm-6">
                <div class="card">
      ...
      @error('name')
            ...
            @endif
            <!-- [ form-element ] start -->
            @if($user->is_admin==1||$permission->cat_bolg_show==2) 
            <div class="col-sm-6">
                <div class="card">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Name</th>
                                          ...
                                          @if($user->is_admin==1||$permission->cat_blog_delete==2) 
                                        <th>Action</th>
                                        @endif
                                    </tr>
                                </thead>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>If you delete this blog category, related Blogs  also be deleted!</p>
