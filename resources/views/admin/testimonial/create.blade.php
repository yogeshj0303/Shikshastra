...
<link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-bs4.min.css" rel="stylesheet">
   ...
   <style>
    ...
    <input type="text" class="form-control" name="name" value="{{ old('name') }}"  id="nameInput" aria-describedby="nameError" required>
...
<div class="col-6 form-floating mb-3">
    <div class="form-group">
        <label class="floating-label" for="Email">Image</label>
...
<div class="form-group">
    <label class="floating-label" for="Email">Date</label>
    <input type="date" class="form-control" value="{{ old('date')}}" name="date" id="dateInput" aria-describedby="dateError" required>
