                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @enderror
                                    ...
                                    <div class="form-group">
                                        <label class="floating-label" for="Email">Select Subject</label>
                                        <select name="subject_id" class="form-control" id="">
                                            <option value="">--Select Subject--</option>
                                            @foreach($subjects as $temp)
                                            <option value="{{$temp->id}}">{{$temp->subject_name}}</option>
                                            @endforeach
                                        </select>
                                          <span class="text-danger" id="nameError">
                                @error('subject_name')
                            ...
                            @enderror
                             ...
                             <div class="form-group">
                                        <label class="floating-label" for="Email">Chapter Name</label>
                                        <input type="text" class="form-control" name="chapter_name" id="nameInput" aria-describedby="emailHelp" required>
                                          <span class="text-danger" id="nameError">
                              @error('chapter_name')
                              {{$message}}
