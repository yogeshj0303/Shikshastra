	...
	max-width: 560px;" class="container">
          ...
          <tr>
			...
			font-family: sans-serif;" class="paragraph">
              Dear {{$name}},<br> We appreciate you choosing to use our service. We must validate your email address 
              in order to protect the security of your account. Please click the following link to verify your email:
            </td>
          </tr>
          <tr>
            <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			padding-bottom: 50px;" class="button">
              <a href="{{URL::to('verification')}}/{{$rand_id}}"><button style="color:#bb0001">Verify Email Address</button>
					</a>
					Please discard this emailif you didn't register for an account with us.<br>
